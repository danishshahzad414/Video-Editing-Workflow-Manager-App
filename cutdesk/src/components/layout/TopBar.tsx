    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          {/* Title or greeting */}
          {title ? (
            <h1 style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 800, fontSize: 18, color: '#111827', margin: 0 }}>
              {title}
            </h1>
          ) : (
            <div className="min-w-0">
              <p style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 600, fontSize: 14, color: '#111827', margin: 0, whiteSpace: 'nowrap' }}>
                {greeting()}, <span style={{ color: '#0284C7' }}>{firstName}</span> 👋
              </p>
              <p style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 400, fontSize: 11, color: '#94A3B8', margin: 0, whiteSpace: 'nowrap' }}>
                {today}
              </p>
            </div>
          )}
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span style={{ fontFamily: 'Plus Jakarta Sans', fontSize: 12, color: '#94A3B8' }}>Quick search…</span>
