                      ...
                      {(provided: any, snapshot: any) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0 cursor-pointer" onClick={() => setDetailVideo(video)}>
                            <p className="text-sm font-bold truncate" style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 700, color: '#0F172A' }}>{video.title}</p>
                            <p className="text-xs mt-0.5" style={{ fontFamily: 'Plus Jakarta Sans', color: '#94A3B8' }}>
                          ...
                          <div className="flex gap-2 flex-shrink-0">
                            ...
                            <button
                              ...
                              style={{ background: '#FEE2E2', color: '#EF4444', fontFamily: 'Plus Jakarta Sans', fontWeight: 700, border: 'none', cursor: 'pointer' }}
        ...
        <div className="modal-overlay" onClick={() => setRevisionVideo(null)}>
          <div className="rounded-2xl overflow-hidden w-full max-w-lg scale-in" style={{ background: '#FFFFFF', border: '1px solid #E2E8F0', boxShadow: '0 20px 60px rgba(0,0,0,0.12)' }} onClick={e => e.stopPropagation()}>
            <div className="px-6 py-4" style={{ background: '#F8FAFC', borderBottom: '1px solid #E2E8F0' }}>
              <h2 style={{ fontFamily: 'Plus Jakarta Sans', fontWeight: 800, fontSize: 18, color: '#0F172A', margin: 0 }}>Request Revision</h2>
              <p className="text-xs mt-0.5" style={{ fontFamily: 'Plus Jakarta Sans', color: '#94A3B8' }}>{revisionVideo.title}</p>
            </div>
            <div className="p-6">
              {templates.length > 0 && (
                <div className="mb-3">
